  ...
  return (
    <>
      ...
      <section className="relative flex min-h-[92vh] items-center overflow-hidden">
        {/* Backdrop — theme-aware: dark warm gradient in dark mode, flat
            white (matching header/footer) in light mode. */}
        <div className="absolute inset-0 -z-10">
          <div className="absolute inset-0 bg-gradient-to-br from-surface-sunken via-surface-raised to-surface-bg" />
          <div className="absolute inset-0 bg-noise-texture opacity-60 [html[data-theme=light]_&]:opacity-0" />
          <div className="absolute left-1/2 top-0 h-[600px] w-[600px] -translate-x-1/2 rounded-full bg-gold/10 blur-[120px] [html[data-theme=light]_&]:opacity-0" />
        </div>
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 pt-28 sm:px-6 lg:grid-cols-2 lg:px-8">
          <div className="animate-fade-in-up">
            ...
            <h1 className="mt-6 font-serif text-5xl font-bold leading-[1.05] text-content sm:text-6xl lg:text-7xl">
              Where Fire Meets
            ...
            {/* Trust row */}
            <div className="mt-12 flex flex-wrap items-center gap-8 text-sm text-content-dim">
          ...
          <div className="relative animate-scale-in">
            ...
            <div className="card absolute -bottom-6 -left-6 hidden items-center gap-3 px-5 py-4 sm:flex">
              ...
              <div>
                <p className="font-serif text-lg font-semibold text-content">Master Grill</p>
                <p className="text-xs text-content-dim">Charcoal-fired, 800°C sear</p>
              </div>
            </div>
          </div>
        </div>
